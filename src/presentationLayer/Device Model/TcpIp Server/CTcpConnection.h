...
/**
 * Class encapsulate boost::ip::tcp::socket and additional features: - send one
...
public:
	...
	CTcpConnection(ip::tcp::socket& socket, CTcpConnectionListener* listener, uint32_t maxBufSize, uint32_t messageTimeout, uint32_t messageFragmentTimeout);
	...
	void onReceive(error_code& err, size_t bytes);
